...
export default function CollectionCard({
    ...
    return <div className={`parent-div group leading-11 p-4 ${customClass}`}
        style={{
        ...
        <button className="group-hover:scale-110 transition-transform duration-100 shop-btn cursor-pointer flex gap-1 items-center justify-end text-white text-sm-inter">
